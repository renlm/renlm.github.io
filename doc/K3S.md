...
修改环境变量：GF_DATABASE_TYPE=postgres
修改环境变量：GF_DATABASE_HOST=postgres.dev:5432
修改环境变量：GF_DATABASE_NAME=grafana
修改环境变量：GF_DATABASE_USER=grafana
修改环境变量：GF_DATABASE_PASSWORD=pwd

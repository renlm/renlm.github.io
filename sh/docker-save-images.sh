...
########################################################################
### 生成离线镜像包
# $ curl -sfL https://renlm.github.io/sh/docker-save-images.sh | PLATFORM=linux/amd64 sh -s - -i registry:3.1.1 -i httpd:2 -o registry-3.1.1
# $ curl -sfL https://renlm.github.io/sh/docker-save-images.sh | PLATFORM=linux/arm64 sh -s - -i registry:3.1.1 -i httpd:2 -o registry-3.1.1
